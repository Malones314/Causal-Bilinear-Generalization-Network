...
在“[trained models](https://drive.google.com/drive/folders/17fMiulPXF-7IOFExEVd99Z7xuP_eXLP3?usp=sharing)”中下载.pth文件，将文件地址导入到loadCheckpointTest.py中，即可查看测试结果，所用数据集为MIMII DG和MIMII，可在此下载：https://zenodo.org/records/6529888 以及 https://zenodo.org/record/3384388 或者 https://drive.google.com/drive/folders/17Kz4HvcyOePa35TeIww1ZQHgzvdyPY7Q?usp=sharing (已经做好了预处理)。

本论文实验部分中对比方法的论文复现代码存放于：otherMethods


Download the .pth file from the “[trained models](https://drive.google.com/drive/folders/17fMiulPXF-7IOFExEVd99Z7xuP_eXLP3?usp=sharing)” and import the file path into loadCheckpointTest.py to view the test results. The dataset used are MIMII DG and MIMII, which can be downloaded here: https://zenodo.org/records/6529888 and https://zenodo.org/record/3384388 or https://drive.google.com/drive/folders/17Kz4HvcyOePa35TeIww1ZQHgzvdyPY7Q?usp=sharing (Preprocessing has been completed).
